 ...
 */
	...
	Router::connect('/food', array('controller' => 'menus', 'action' => 'index'));
	
	// launch subscription url
	Router::connect('/register', array('controller' => 'pages', 'action' => 'view', 'oconnors-bar-merchandise'));
?>