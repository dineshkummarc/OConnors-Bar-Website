<?php
	...
	$mcFileManagerConfig['general.tools'] = "createdir,createdoc,refresh,zip,upload,rename,cut,copy,paste,delete,selectall,unselectall,view,download,insert,addfavorite,removefavorite,imagemanager";
	...
	$mcFileManagerConfig['filesystem.path'] = '../../../img/uploads'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = '../../../img/uploads'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,wmv,flv";
